...
<div class="min-h-screen bg-gray-50/50">
  ...
  {:else if category}
    <!-- Hero Section -->
    <div class="relative h-100 overflow-hidden bg-gray-900">
      ...
      {:else}
        <div
          class="absolute inset-0 bg-linear-to-br from-indigo-900 via-blue-900 to-purple-900 opacity-80"
        ></div>
        <!-- Decorative elements -->
            ...
            {#if category.club}
              ...
              >
                {#if category.club.logoUrl}
                  ...
                  />
                {/if}
                <span class="font-bold">{category.club.name}</span>
              </div>
            {/if}
            <div
    ...
    >
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-4 space-y-8">
          ...
          <div
            class="bg-linear-to-br from-indigo-600 to-purple-700 rounded-3xl p-8 text-white shadow-xl shadow-indigo-200"
          ...
          >
            <h4 class="font-black text-gray-900 text-xl mb-4">Interested?</h4>
            <p class="text-gray-500 text-sm mb-6 leading-relaxed">
              Check out the club's upcoming events to find one of this type!
            </p>
            <button
