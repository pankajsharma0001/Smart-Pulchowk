...
>
  ...
  {#if isNavigating && !isMapFullscreen}
    <div
      class="absolute top-6 left-1/2 -translate-x-1/2 z-40 w-full max-sm px-4 pointer-events-auto"
  ...
  >
    {#if isNavigating && isMapFullscreen}
      <div
        class="absolute top-6 left-1/2 -translate-x-1/2 z-60 w-full max-sm px-4 pointer-events-auto"
        transition:fade={{ duration: 200 }}
      >
        <div
          class="bg-white/90 backdrop-blur-xl rounded-xl shadow-lg shadow-gray-200/40 border border-gray-100 p-3.5"
    ...
    {#if !isNavigating && isMapFullscreen}
      <div
        class="absolute top-6 left-1/2 -translate-x-1/2 z-60 w-full max-md px-4"
      >
        <div class="relative group">
          <div
            class="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 transition-colors group-focus-within:text-blue-600 z-10"
